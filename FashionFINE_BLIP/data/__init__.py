...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    if dataset=='pretrain':
        ...
        val_dataset = coco_karpathy_retrieval_eval(transform_test, config['image_root'], config['ann_root_test'], 'val') 
        ...
        train_dataset = coco_karpathy_train(transform_train, config['image_root'], config['ann_root_train'])
        val_dataset = coco_karpathy_retrieval_eval(transform_test, config['image_root'], config['ann_root_test'], 'val') 
        test_dataset = coco_karpathy_retrieval_eval(transform_test, config['image_root'], config['ann_root_test'], 'test')          
        return train_dataset, val_dataset, test_dataset    
