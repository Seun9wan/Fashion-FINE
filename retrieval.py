...
from models.model_retrieval import FashionFINE
...
def train(model, data_loader, optimizer, tokenizer, epoch, warmup_steps, device, scheduler, config, output_dir):
    # train
    model.train()  
...
def main(args, config):
    ...
    for epoch in range(0, max_epoch):
        if not args.evaluate:
            ...
            train_stats = train(model, train_loader, optimizer, tokenizer, epoch, warmup_steps, device, lr_scheduler, config, args.output_dir)  
            print(train_stats)
